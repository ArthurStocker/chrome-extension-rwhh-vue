...
<template>
  <b-input-group size="sm">
    <b-form-input :key="field" :data-name="name" :data-row="record.index" :data-col="field" :data-methods="methods" :type="record.field.type" :value="valueTransformer('text', record, field)" :disabled="!editable" @input="storeCommitEvent"></b-form-input>
    <b-input-group-append>
      <b-button :data-name="name" :data-row="record.index" :data-col="field" :data-methods="methods" @click="storeCommitEvent" variant="outline-primary">
