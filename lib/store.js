...
const store = new Vuex.Store({
    ...
    state: {
        ...
        datasets: [{
                ...
                title: 'Hosts',
                definition: [
                    { key: 'c', label: '&nbsp;', type: 'delete', editable: -1, class: "d-none", formatter: (value, key, item) => { return value } },
    ...
    mutations: {
        ...
        editable: (state, data) => {
            ...
            console.log(state.datasets.filter((dataset) => dataset.id === state.activeComponent)[0].definition.filter((field) => field.key === 'c')[0])
